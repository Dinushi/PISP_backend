...
import pisp.factories.UserApiServiceFactory;
...
public class UserApi  {
   ...
   private final UserApiService delegate = UserApiServiceFactory.getUserApi();
    ...
    {
     return delegate.eshopLogin(contentType,request,body);
    }
    ...
    public Response updateEshopProfile(@ApiParam(value = "username of the e-shop that need to be updated",required=true ) @PathParam("username")  String username,
    ...
    {
    return delegate.updateEshopProfile(username,contentType,request,cookie,body);
    }
    ...
    @Consumes({ "application/json" })
    @Produces({ "application/json" })
    @io.swagger.annotations.ApiOperation(value = "Add and register a new psu with PISP", notes = "Customer of ecommerce site can register with PISP.", response = void.class)
    @io.swagger.annotations.ApiResponses(value = {
    ...
    public Response addNewPSU(@ApiParam(value = "Chosen content type" ,required=true , allowableValues="{values=[application/json]}")@HeaderParam("Content-Type") String contentType,
                                @ApiParam(value = "created new psu object" ,required=true ) PSUProfileDTO body)
    {
     return delegate.addNewPSU(contentType,body);
    }
    @POST
    @Path("/psu/login")
    ...
    public Response loginPSU(@ApiParam(value = "Chosen content type" ,required=true , allowableValues="{values=[application/json]}")@HeaderParam("Content-Type") String contentType,
    ...
    {
     return delegate.loginPSU(contentType,paymentInitReqId,request,body);
    }
