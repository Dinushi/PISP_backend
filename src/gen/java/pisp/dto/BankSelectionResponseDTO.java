...
public class BankSelectionResponseDTO  {
   ...
   **/
  @ApiModelProperty(required = true, value = "Specifies True, if customer account is essential to initiate a payment in the selected bank")
   ...
   **/
  @ApiModelProperty(required = true, value = "Specifies True, if a submission flow is required to be done after PSU authorization of payment")
