 ...
 * expressed in the currency as ordered by the ecommerce site. Usage- This amount has to be
...
@ApiModel(description = "Amount of money to be moved between the debtor and creditor, " +
        "before deduction of charges, expressed in the currency as ordered by the e-commerce site." +
...
public class PaymentHistoryInnerInstructedAmountDTO {
     ...
     **/
    @ApiModelProperty(value = "A code allocated to a currency by a Maintenance Agency under" +
            "an international identification scheme")
