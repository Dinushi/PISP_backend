...
//these for UK v2
    ...
    //Redirect Links : needed to be updated as per the deployment
    public static final String REDIRECT_LINK_SELECT_DEBTOR_BANK = "http://localhost:8080/#/psuLogin/?";
