...
public class PispFlowUK extends GenericPispFlowImpl {
    ...
    */
     ...
     */
    @Override
    public InternalResponse processPaymentAfterPSUAuthorization(String code, Payment payment) {
        ...
        if (paymentStatus.equals(Constants.UK_TRANSACTION_STATUS_AFTER_SUBMISSION)) {
            return new InternalResponse(Constants.PAYMENT_COMPLETED, true);
        } else {
            return new InternalResponse(Constants.PAYMENT_COMPLETION_FAILED, false);
        }
    }
