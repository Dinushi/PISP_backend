...
public class MySQLStatements {
    ...
    public static final String UPDATE_E_SHOP = "UPDATE E_SHOPS SET E_SHOP_USERNAME  = ?, E_SHOP_NAME=? ," +
            " REGISTERED_NO=?, REGISTERED_BUSINESS_NAME=?,REGISTERED_COUNTRY=?, EMAIL=?  WHERE E_SHOP_USERNAME = ?;";
    ...
    public static final String ADD_SESSION_TOKEN_FOR_ESHOP = "INSERT INTO ESHOP_SESSION_TOKENS (E_SHOP_USERNAME, " +
            "SESSION_KEY, EXPIRY_TIME) VALUES(?, ?, ?) ON DUPLICATE KEY UPDATE SESSION_KEY=?, EXPIRY_TIME=?;";
    ...
    public static final String ADD_NEW_MERCHANT = "INSERT INTO MERCHANTS  (MERCHANT_ID , CLIENT_ID, " +
    ...
    public static final String ADD_NEW_PAYMENT_INITIATION = "INSERT INTO PAYMENTS  (PAYMENT_INIT_REQ_ID , CLIENT_ID, " +
            "MERCHANT_ID, PURCHASE_ID,CURRENCY, PAYMENT_AMOUNT, CUSTOMER_IDENTIFICATION_BY_ESHOP, DELIVERY_ADDRESS_JSON," +
    ...
    public static final String UPDATE_MERCHANT_IDENTIFICATION_BY_ESHOP = "UPDATE MERCHANTS SET " +
            " MERCHANT_IDENTIFICATION_BY_ESHOP = ? WHERE MERCHANT_IDENTIFICATION_BY_ESHOP = ?;";
