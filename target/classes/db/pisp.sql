...
CREATE TABLE IF NOT EXISTS MERCHANTS (
  ...
  CONSTRAINT Fk_merchant_client_id FOREIGN KEY (CLIENT_ID) REFERENCES E_SHOPS (CLIENT_ID) ON DELETE CASCADE,
  CONSTRAINT pk_merchant PRIMARY KEY (CLIENT_ID,MERCHANT_IDENTIFICATION_BY_ESHOP),
...
CREATE TABLE IF NOT EXISTS PAYMENTS (
  ...
  CONSTRAINT Fk_payments_client_id FOREIGN KEY (CLIENT_ID) REFERENCES E_SHOPS(CLIENT_ID) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS PURCHASE_ITEMS (
  ...
  CONSTRAINT pk_purchase_items PRIMARY KEY (ENTRY_ID)
)
  ENGINE = InnoDB;


CREATE TABLE IF NOT EXISTS PAYMENTS_PURCHASE_ITEMS_MAPPING (
  PAYMENT_INIT_REQ_ID    VARCHAR(255)   NOT NULL,
  ENTRY_ID       VARCHAR(255)   NOT NULL,
  CONSTRAINT pk_payments_purchase_items_mapping PRIMARY KEY (PAYMENT_INIT_REQ_ID,ENTRY_ID),
  CONSTRAINT Fk_payments_purchase_items_mapping1 FOREIGN KEY (PAYMENT_INIT_REQ_ID) REFERENCES PAYMENTS (PAYMENT_INIT_REQ_ID) ON DELETE CASCADE,
  CONSTRAINT Fk_payments_purchase_items_mapping2 FOREIGN KEY (ENTRY_ID) REFERENCES PURCHASE_ITEMS (ENTRY_ID) ON DELETE CASCADE
